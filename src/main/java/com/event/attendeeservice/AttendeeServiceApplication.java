package com.event.attendeeservice;

import com.event.attendeeservice.Repository.*;
import com.event.attendeeservice.entity.*;
...
public class AttendeeServiceApplication implements CommandLineRunner {
	@Autowired
